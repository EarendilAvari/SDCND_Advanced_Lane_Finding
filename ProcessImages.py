...
# Get binary images
challengeFr1GradX_Lch2 = binImg.GradientCalc(challengeFr1ud, imgType = 'HSL', imgChannel = 'l', calcType = 'dirX', kernelSize = 3, thresh = (10, 180))
challengeFr1L_ch2 = binImg.HSLBinary(challengeFr1ud, imgChannel = 'l', thresh = (190, 255))
challengeFr1S_ch2 = binImg.HSLBinary(challengeFr1ud, imgChannel = 's', thresh = (90, 250))

challengeFr1GradX_Lch2_L = cv2.bitwise_and(challengeFr1GradX_Lch2, challengeFr1L_ch2)

challengeFr2GradX_Lch2 = binImg.GradientCalc(challengeFr2ud, imgType = 'HSL', imgChannel = 'l', calcType = 'dirX', kernelSize = 3, thresh = (10, 180))
challengeFr2L_ch2 = binImg.HSLBinary(challengeFr2ud, imgChannel = 'l', thresh = (190, 255))
challengeFr2S_ch2 = binImg.HSLBinary(challengeFr2ud, imgChannel = 's', thresh = (90, 250))
